# Chat-Task-Tic Overlay (Horizontal)

<img src="./images/thumbnail.png" height="200" alt="Chat-Task-Tic Overlay Horizontal Preview"/>
...
<img src="./images/thumbnail_labeled.png" height="200" alt="Chat-Task-Tic Overlay Preview"/>
...
`taskListPadding` - padding of the task list (px)
...
`headerWidth` - width of the header (px)
...
`usernameMaxWidth` - max width of the username (px)
...
`taskMarginRight` - margin right of the task (px)

`taskPadding` - padding of the task (px)

`taskMaxWidth` - max width of the task (px)
...
-    [**@MohFocus**](https://twitch.tv/MohFocus) \(for the base of the code\)
